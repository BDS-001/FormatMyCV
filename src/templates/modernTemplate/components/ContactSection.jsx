    ...
    <div className={styles.sidebarSection}>
      ...
      <div className={styles.sidebarSectionContent}>
        <div className={styles.contactItem}>
          ...
          <div id="sidebarEmail" className={styles.contactText}>
            {contactData.email}
          </div>
        </div>
        {contactData.phone && (
          <div className={styles.contactItem}>
            ...
            <div id="sidebarPhone" className={styles.contactText}>
        ...
        <div className={styles.contactItem}>
          ...
          <div id="sidebarLocation" className={styles.contactText}>
        ...
        {contactData.linkedin && (
          <div className={styles.contactItem} id="linkedinContainer">
            ...
            <div id="sidebarLinkedin" className={styles.contactText}>
              {stripProtocol(contactData.linkedin)}
            </div>
          </div>
        )}
        {contactData.github && (
          <div className={styles.contactItem} id="githubContainer">
            ...
            <div id="sidebarGithub" className={styles.contactText}>
              {stripProtocol(contactData.github)}
            </div>
          </div>
        )}
        {contactData.website && (
          <div className={styles.contactItem} id="websiteContainer">
            ...
            <div id="sidebarWebsite" className={styles.contactText}>
              {stripProtocol(contactData.website)}
            </div>
          </div>
        )}
      </div>
