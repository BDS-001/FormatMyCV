        ...
        <div className="sidebar-section">
            ...
            <div className="sidebar-section-content">
                <div className="contact-item">
                    ...
                    <div id="sidebarEmail" className="contact-text">email@example.com</div>
                </div>
                <div className="contact-item">
                    <svg className="contact-icon" viewBox="0 0 24 24" fill="white">
                    ...
                    <div id="sidebarPhone" className="contact-text">(123) 456-7890</div>
                </div>
                <div className="contact-item">
                    <svg className="contact-icon" viewBox="0 0 24 24" fill="white">
                        <path d="M12 2C8.13 2 5 5.13 5 9C5 14.25 12 22 12 22C12 22 19 14.25 19 9C19 5.13 15.87 2 12 2ZM12 11.5C10.62 11.5 9.5 10.38 9.5 9C9.5 7.62 10.62 6.5 12 6.5C13.38 6.5 14.5 7.62 14.5 9C14.5 10.38 13.38 11.5 12 11.5Z"/>
                    </svg>
                    <div id="sidebarLocation" className="contact-text">City, State</div>
                </div>
                <div className="contact-item" id="linkedinContainer">
                    ...
                    <div id="sidebarLinkedin" className="contact-text">linkedin.com/in/yourprofile</div>
                </div>
                <div className="contact-item" id="websiteContainer">
                    ...
                    <div id="sidebarWebsite" className="contact-text">yourwebsite.com</div>
                </div>
            </div>
        </div>
    );
